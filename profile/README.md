...
> [!IMPORTANT]
> Ao usar a Hanae, você concorda com todos os Termos de Uso.

## Essas são as informações que coletamos:

### 1. Informações de sua conta:

Ao usar a Hanae, suas informações que incluem, mas não se limitam a **ID** e **Nome**, serão salvas para uso no futuro. Seguindo todos os [Termos de Serviço do Discord](https://discord.com/terms).
